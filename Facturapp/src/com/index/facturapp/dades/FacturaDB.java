...
import com.index.facturapp.clasesextra.FileUtils;
...
public class FacturaDB extends SQLiteOpenHelper {
	...
	public String backupDatabase(Context context) throws IOException {
        ...
        String outFileName = Environment.getExternalStorageDirectory()+"/DBFacturapp.factDB";
	...
	public boolean importDatabase(String dbPath, Context context) throws IOException {
	    ...
	    File oldDb = new File(context.getDatabasePath(DATABASE_NAME).getAbsolutePath());
	    if (newDb.exists()) {
